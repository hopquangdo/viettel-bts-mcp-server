...
import vn.edu.huce.iic.bts_ops_platform.dto.common.OutputSummaryDto;
import vn.edu.huce.iic.bts_ops_platform.dto.common.PagedResult;
import vn.edu.huce.iic.bts_ops_platform.dto.common.PeriodInfo;
import vn.edu.huce.iic.bts_ops_platform.dto.common.PeriodTrendDto;
import vn.edu.huce.iic.bts_ops_platform.dto.common.ProgressSummaryDto;
import vn.edu.huce.iic.bts_ops_platform.dto.common.RankedEntityDto;
import vn.edu.huce.iic.bts_ops_platform.dto.common.RankingOverviewDto;
import vn.edu.huce.iic.bts_ops_platform.dto.sanluong.SanLuongPeriodTrendDto;
import vn.edu.huce.iic.bts_ops_platform.dto.sanluong.SanLuongNhaThauChuaBaoItem;
import vn.edu.huce.iic.bts_ops_platform.dto.sanluong.SanLuongDoiTuongChuaCoItem;
import vn.edu.huce.iic.bts_ops_platform.dto.sanluong.SanLuongNghiemThuDto;
import vn.edu.huce.iic.bts_ops_platform.dto.sanluong.SanLuongQueryResponse;
import vn.edu.huce.iic.bts_ops_platform.dto.sanluong.DoiTuongListProjection;
import vn.edu.huce.iic.bts_ops_platform.dto.sanluong.HangMucDoiTuongProjection;
import vn.edu.huce.iic.bts_ops_platform.dto.sanluong.SanLuongHangMucDoiTuongDto;
import vn.edu.huce.iic.bts_ops_platform.dto.sanluong.SanLuongHangMucItem;
import vn.edu.huce.iic.bts_ops_platform.dto.sanluong.SanLuongDoiTuongItem;
...
import vn.edu.huce.iic.bts_ops_platform.repository.SanLuongToolRepository;
...
import vn.edu.huce.iic.bts_ops_platform.support.PeriodComparisonHelper;
import vn.edu.huce.iic.bts_ops_platform.support.RankingBuilder;
import vn.edu.huce.iic.bts_ops_platform.support.TrendCalculator;
...
public class SanLuongToolHandlerImpl implements SanLuongToolHandler {
    ...
    public SanLuongQueryResponse query(String doiTuong, String hopDong, String nhaThau,
        ...
        List<SanLuongNhaThauChuaBaoItem> nhaThauChuaBaoTrongKy = nhaThauChuaBaoRows.stream()
                .map(SanLuongToolHandlerImpl::mapNhaThauChuaBao)
                .toList();
        PagedResult<SanLuongNhaThauChuaBaoItem> nhaThauChuaBaoTrongKyPaged = PagedResult.of(
    ...
    private static SanLuongNhaThauChuaBaoItem mapNhaThauChuaBao(NhaThauChuaBaoProjection row) {
