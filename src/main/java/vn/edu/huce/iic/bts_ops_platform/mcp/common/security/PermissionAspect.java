...
public class PermissionAspect {
    ...
    @Before("@annotation(vn.edu.huce.iic.bts_ops_platform.mcp.common.security.RequiresPermission)"
            + " || @within(vn.edu.huce.iic.bts_ops_platform.mcp.common.security.RequiresPermission)")
