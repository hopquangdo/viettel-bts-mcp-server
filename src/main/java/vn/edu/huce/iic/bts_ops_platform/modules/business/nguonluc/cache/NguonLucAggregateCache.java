...
/**
 * Cache in-memory ngắn hạn cho số liệu tổng hợp nguồn lực (NguonLucService.dangTrienKhai) —
 * cùng pattern với TramTonAggregateCache/HopDongAggregateCache/PhanCongAggregateCache.
 */
@Component
public class NguonLucAggregateCache {

    /**
     * TTL dài vì cache được evict chủ động qua event (HopDongDeletedEvent, HopDongCanceledEvent,
     * SanLuongChangedEvent, HopDongDoiTuongCascadeDeleteEvent) — xem NguonLucAggregateCacheInvalidationListener.
     */
