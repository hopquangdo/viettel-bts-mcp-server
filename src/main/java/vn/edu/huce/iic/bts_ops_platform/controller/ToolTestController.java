...
import vn.edu.huce.iic.bts_ops_platform.metrics.McpToolStats;
...
@RestController
@RequestMapping("/api/v1/tools/test")
...
public class ToolTestController {
    ...
    public ResponseEntity<ApiResponse<vn.edu.huce.iic.bts_ops_platform.dto.nhatky.NhatKyQueryResponse>> nhatKy(
            @RequestParam(required = false) String maDoiTuong,
            @RequestParam(required = false) String maHopDong,
        ...
        return ApiResponse.<vn.edu.huce.iic.bts_ops_platform.dto.nhatky.NhatKyQueryResponse>build().withData(result).toEntity();
    }
