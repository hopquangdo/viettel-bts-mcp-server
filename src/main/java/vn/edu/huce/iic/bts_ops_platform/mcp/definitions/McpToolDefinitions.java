...
import vn.edu.huce.iic.bts_ops_platform.mcp.dto.common.DoiTuongOverviewResponse;
import vn.edu.huce.iic.bts_ops_platform.mcp.dto.common.SystemOverviewResponse;
...
import vn.edu.huce.iic.bts_ops_platform.mcp.handler.HopDongToolHandler;
...
import vn.edu.huce.iic.bts_ops_platform.mcp.handler.PhanCongToolHandler;
import vn.edu.huce.iic.bts_ops_platform.mcp.handler.SanLuongToolHandler;
import vn.edu.huce.iic.bts_ops_platform.mcp.handler.TramTonToolHandler;
...
public class McpToolDefinitions {
    ...
    private final vn.edu.huce.iic.bts_ops_platform.mcp.handler.NhatKyToolHandler nhatKyToolHandler;
    ...
    public vn.edu.huce.iic.bts_ops_platform.mcp.dto.nhatky.NhatKyQueryResponse nhatKy(
            @ToolParam(description = ToolParamDescriptions.DOI_TUONG, required = false) String doiTuong,
            @ToolParam(description = ToolParamDescriptions.HOP_DONG, required = false) String hopDong,
    ...
    public SystemOverviewResponse systemOverview(
        ...
        return SystemOverviewResponse.builder()
                .hopDong(hopDongToolHandler.query(null, hopDong, nhaThau, khuVuc, tinhThanh, null, null, null, null, null, null, null, null, top, null, null, null))
                .sanLuong(sanLuongToolHandler.query(null, hopDong, nhaThau, khuVuc, tinhThanh, fromDate, toDate, null, null, null, null, null, null, null, null))
                .phanCong(phanCongToolHandler.query(null, nhaThau, null, null, hopDong, khuVuc, tinhThanh, null, null, null, top, null, null, null, null))
                .tramTon(doiTuongTonToolHandler.query(null, hopDong, nhaThau, khuVuc, tinhThanh, null, null, null, null, top, null, null, null, null, null))
                .vuongMac(vuongMacToolHandler.query(null, hopDong, nhaThau, khuVuc, tinhThanh, null, null, null, null, null, null, top, null, null, null, null, null, null, null))
                .bienBan(bienBanToolHandler.query(khuVuc, tinhThanh, hopDong, nhaThau, null, null, null, null, null, null))
                .nguonViec(nguonViecToolHandler.query(khuVuc, nhaThau, null, null, null, null, null, null, null, null, top, null, null, null))
                .build();
    }
    ...
    public DoiTuongOverviewResponse doiTuong(
        ...
        return DoiTuongOverviewResponse.builder()
                ...
                .phanCong(phanCongToolHandler.query(null, null, null, null, null, null, null, doiTuong, null, null, null, null, null, fromDate, toDate))
